...
public class LobbyManager : MonoBehaviour {
    ...
    //public static IAuthenticationService TInstance { get; }
    ...
    public async void Authenticate(string email) {
        ...
        initializationOptions.SetProfile(email);
    ...
    try {
            ...
            Debug.Log("Signed in! " + FirebaseAuth.DefaultInstance.CurrentUser.UserId);
        ...
        if (joinedLobby != null) {
            ...
            if (lobbyPollTimer < 0f) {
                ...
                if (joinedLobby.Data[KEY_START_GAME].Value != "0"){
                    //Start Game!
                    if (!IsLobbyHost()){
                        RelayScript.Instance.JoinRelay(joinedLobby.Data[KEY_START_GAME].Value);
                    }
    ...
    private Player GetPlayer() {
        return new Player(AuthenticationService.Instance.PlayerId, null, new Dictionary<string, PlayerDataObject> {
            { KEY_PLAYER_NAME, new PlayerDataObject(PlayerDataObject.VisibilityOptions.Public, email) },
    ...
    public async void UpdatePlayerName(string email) {
        this.email = email;
